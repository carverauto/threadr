...
var _ = Describe("IRCBot Controller", func() {
	Context("When reconciling a resource", func() {
		...
		BeforeEach(func() {
			By("creating the custom resource for the Kind IRCBot")
			err := k8sClient.Get(ctx, typeNamespacedName, ircbot)
		...
		It("should successfully reconcile the resource", func() {
			...
			controllerReconciler := &IRCBotReconciler{
				Client: k8sClient,
