...
- [x] 2.2 Add operational verification that message embeddings keep pace with ingested history for QA workloads.
...
- [x] 3.3 Verify UI QA uses the same actor-centric retrieval path as bot QA for equivalent questions.
